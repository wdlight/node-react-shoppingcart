...
const Cart = () => {
  ...
  // Stripe를 활용하여 결제하기
  // "Pay With Stripe" 버튼 처리 함수.
  const handleCheckout = async () =>{ // await로 대기 하는 동작을 위해서는 함수 선언에 async 선언이 필요함.
    ...
    console.log( "cart.jsx:" + JSON.stringify(cartItems))
    ...
    console.log ( "return data from json:" + data )
